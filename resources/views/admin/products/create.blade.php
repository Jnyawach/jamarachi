...
@section('content')
    <section class="p-4">
        ...
        <hr>
        <div class="save bg-light p-3 position-static">
            ...
            <div class="accordion accordion-flush mt-5" id="accordionFlushExample">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">,o make it look, at least at first glance, a bit more representative of how this would look in a real-world application.</div>
                    </div>
                </div>
            </div>
